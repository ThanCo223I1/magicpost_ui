    ...
    return (
        <div style={{marginTop: '0px'}}>
            ...
            <div className="mainHeader--height">
                ...
                {/*                        <a href="#" itemProp="url" title="GHN.VN Giao Hàng Nhanh">*/}
                {/*                            <h1 className="logo">*/}
                ...
                <header className="app-header navbar" style={{
                    ...
                    <a href="" className="navbar-brand col-2" style={{marginLeft: '0px', top:'-8%'}}>
                            ...
                            <section className="section section-banner">
                                <div className="container">
                                    <div className="s-title text-center">
                                        ...
                                        <p>MagicPost giúp bạn giao hàng đến người nhận nhanh hơn 6 tiếng so với các đơn vị vận
                                            chuyển khác.</p>
                                    </div>
