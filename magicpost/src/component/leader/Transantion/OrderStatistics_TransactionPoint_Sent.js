...
const OrderStatistics_TransactionPoint_Sent = () => {
    ...
    useEffect(() => {
        if (selectedYear) {
            axios.get(`http://localhost:8080/orderStatistics/transactionPoint_Leader/sent/${account.id}/year/${selectedYear}`)
                .then(function (res) {
            ...
            <div className="distanceBody">
                ...
                * Vui lòng chọn năm để xem thống kê
                ...
                <div style={{marginTop: "1%"}}>
                    <table className="table m-auto" style={{width: "50%"}}>
                        <tr>
                            <th className="text-center" style={{width: "26%"}}>Tổng hoá đơn đã gửi đi
...
export default OrderStatistics_TransactionPoint_Sent;