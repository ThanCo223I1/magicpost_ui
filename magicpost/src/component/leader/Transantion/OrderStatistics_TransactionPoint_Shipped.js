...
const OrderStatistics_TransactionPoint_Shipped = () => {
    ...
    useEffect(() => {
        if (selectedYear && selectedStatus) {
            axios.get(`http://localhost:8080/orderStatistics/transactionPoint_Leader/${account.id}/status/${selectedStatus}/year/${selectedYear}`)
                .then(function (res) {
            ...
            <div className="distanceBody">
                ...
                * Vui lòng chọn trạng thái
                ...
                <div className="text-center">
                    <h2>Thống kê đơn
                        hàng {selectedStatus !== "select" && (selectedStatus === "3" && "thành công" || selectedStatus === "4" && "huỷ")}
                    </h2>
                </div>
                <div>
...
export default OrderStatistics_TransactionPoint_Shipped;