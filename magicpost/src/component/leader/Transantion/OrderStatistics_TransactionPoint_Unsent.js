...
const OrderStatistics_TransactionPoint_Unsent = () => {
    ...
    useEffect(() => {
        if (selectedYear) {
            axios.get(`http://localhost:8080/orderStatistics/transactionPoint_Leader/unsent/${account.id}/year/${selectedYear}`)
                .then(function (res) {
            ...
            <div className="distanceBody">
                ...
                * Vui lòng chọn năm để xem thống kê
                ...
                <div className="text-center">
                    <h2>Thống kê đơn đã tạo nhưng chưa gửi đi</h2>
                </div>
                <div>
                ...
                <div style={{marginTop: "1%"}}>
                    <table className="table m-auto" style={{width: "50%"}}>
                        <tr>
                            <th className="text-center" style={{width: "26%"}}>Tổng hoá đơn chưa gửi
...
export default OrderStatistics_TransactionPoint_Unsent;