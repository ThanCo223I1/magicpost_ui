...
const OrderStatistics_ConsolidationPoint_StatusShipping = () => {
    ...
    useEffect(() => {
        if (selectedYear) {
            axios.get(`http://localhost:8080/orderStatistics/consolidationPoint_Leader_StatusShipping/${account.id}/year/${selectedYear}`)
                .then(function (res) {
            ...
            <div className="distanceBody">
                ...
                * Vui lòng chọn năm để xem thống kê
                ...
                <div className="text-center">
                    <h2>Thống kê đơn hàng chưa giao</h2>
                </div>
                <div>
                ...
                <div style={{marginTop:"1%"}}>
                    <table className="table m-auto" style={{width: "50%"}}>
                        <tr>
                            <th className="text-center" style={{width: "26%"}}>Tổng hoá đơn chưa giao năm {selectedYear !== "select" && selectedYear}</th>
...
export default OrderStatistics_ConsolidationPoint_StatusShipping;