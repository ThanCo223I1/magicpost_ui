...
const OrderStatistics_ConsolidationPoint_Received = () => {
    ...
    useEffect(() => {
        if (selectedYear) {
            axios.get(`http://localhost:8080/orderStatistics/consolidationPoint_Leader_Received/${account.id}/year/${selectedYear}`)
                .then(function (res) {
            ...
            <div className="distanceBody">
                ...
                * Vui lòng chọn năm để xem thống kê
                ...
                <div className="text-center">
                    <h2>Thống kê đơn hàng đã nhận</h2>
                </div>
                <div>
                ...
                <div style={{marginTop:"1%"}}>
                    <table className="table m-auto" style={{width: "50%"}}>
                        <tr>
                            <th className="text-center" style={{width: "26%"}}>Tổng hoá đơn đã nhận năm {selectedYear !== "select" && selectedYear}</th>
...
export default OrderStatistics_ConsolidationPoint_Received;